...
import mazestormer.controller.PathFinderEvent;
...
public class PathFindingPanel extends ViewPanel {
	...
	public PathFindingPanel(IPathFindingController controller) {
		...
		setBorder(new TitledBorder(null, "Path Finder", TitledBorder.LEADING,
	...
	public void startAction() {
		this.controller.startAction((int) this.xModel.getValue(),
				(int) this.yModel.getValue());
	}

	public void startStepAction() {
		this.controller.startStepAction((int) this.xModel.getValue(),
				(int) this.yModel.getValue());
	}
	...
	@Subscribe
	public void onActionEvent(PathFinderEvent e) {
		setActionButtonState(e.getEventType() == PathFinderEvent.EventType.STARTED);

		if (e.getEventType() == PathFinderEvent.EventType.STOPPED) {
			updateCurrentCoordinates();
		}
	}
